...
<div class="bg-gradient-to-br from-amber-50 to-amber-100 py-16">
  <div class="container mx-auto px-4 sm:px-6 lg:px-12 space-y-20">
    ...
    <section class="bg-white rounded-3xl shadow-xl overflow-hidden transition duration-500 hover:scale-[1.01] hover:shadow-2xl">
      <div class="grid md:grid-cols-2 gap-10 items-center p-8 md:p-14">
        ...
        <div class="order-1 md:order-2 flex justify-center animate-fade-in-up delay-200">
          <img src="{{ asset('images/tempe-illustration.png') }}" alt="Ilustrasi Tempe" class="w-full max-w-md h-auto rounded-2xl shadow-lg ring-4 ring-amber-200 object-cover transform rotate-3 hover:rotate-0 transition-transform duration-300">
        </div>
      </div>
    </section>
    ...
    <section class="space-y-6 text-center">
      <h2 class="text-4xl sm:text-5xl font-extrabold text-zinc-700 group inline-block relative after:absolute after:left-1/2 after:translate-x-[-50%] after:mt-2 after:w-0 after:h-1 after:bg-zinc-400 after:rounded-full group-[.show]:after:w-20 transition-all duration-500 animate-fade-in-up">Misi Kami</h2>
      <div class="bg-white p-8 rounded-2xl shadow-lg border border-amber-100 text-justify space-y-4 animate-fade-in-up delay-100">
    ...
    {{-- Produk Unggulan --}}
    <section class="space-y-6 text-center">
      <h2 class="text-4xl sm:text-5xl font-extrabold text-amber-600 relative after:block after:h-1 after:w-20 after:mt-2 after:mx-auto after:bg-amber-400 after:rounded-full animate-fade-in-up">Produk Unggulan</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-200">
        @foreach($produk as $p)
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:scale-105 transition-transform duration-300 group">
          @if($p->gambar)
          <img src="{{ asset('storage/' . $p->gambar) }}" alt="{{ $p->nama }}" class="w-full h-48 object-cover rounded mb-4 group-hover:scale-105 transition">
          @endif
    ...
    <section class="text-center animate-fade-in-up delay-300">
      <a href="{{ route('edukasi') }}" class="bg-amber-500 hover:bg-amber-600 text-white font-semibold px-10 py-4 rounded-full text-lg shadow-lg transition hover:scale-105 focus:ring-4 focus:ring-amber-300 inline-block">
    ...
    {{-- Program Edukasi --}}
    <section class="space-y-6 text-center">
      <h2 class="text-4xl sm:text-5xl font-extrabold text-blue-600 relative after:block after:h-1 after:w-20 after:mt-2 after:mx-auto after:bg-blue-500 after:rounded-full animate-fade-in-up">Program Edukasi</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-200">
        @foreach($edukasi as $e)
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:scale-105 transition-transform duration-300 group">
          @if($e->gambar)
          <img src="{{ asset('storage/' . $e->gambar) }}" alt="{{ $e->judul }}" class="w-full h-48 object-cover rounded mb-4 group-hover:scale-105 transition">
          @endif
    ...
    <section>
      ...
      <div class="swiper mySwiper mt-6">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide bg-white rounded-lg shadow-md p-6 max-w-lg mx-auto text-center min-h-full flex flex-col justify-between transition duration-300 transform hover:scale-105 hover:shadow-xl">
    ...
    {{-- Lokasi --}}
    <section class="space-y-6 text-center">
      <h2 class="text-4xl sm:text-5xl font-extrabold text-gray-700 relative after:block after:h-1 after:w-20 after:mx-auto after:mt-2 after:bg-gray-400 after:rounded-full animate-fade-in-up">Lokasi Kami</h2>
